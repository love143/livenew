...
(function (a) {
  a.Jcrop = function (b, c) {
    ...
    function t(a) {
      return{x:parseInt(a.x * U, 10), y:parseInt(a.y * V, 10), x2:parseInt(a.x2 * U, 10), y2:parseInt(a.y2 * V, 10), w:parseInt(a.w * U, 10), h:parseInt(a.h * V, 10)}
    }
    ...
    function bg(a, b) {
      ...
      var c = parseInt(a[0], 10) / U, e = parseInt(a[1], 10) / V, f = parseInt(a[2], 10) / U, g = parseInt(a[3], 10) / V;
      if (Y)return;
    ...
    function bh(a) {
      bi([parseInt(a[0], 10) / U, parseInt(a[1], 10) / V, parseInt(a[2], 10) / U, parseInt(a[3], 10) / V]), d.onSelect
        .call(bt, t(ba.getFixed())), bc.enableHandles()
    }
    ...
    function bs(a) {
      d.allowResize ? a ? bc.enableOnly() : bc.enableHandles
    ...
    if (b.tagName == "IMG") {
      if (B[0].width != 0 && B[0].height != 0)B.width(B[0].width), B.height(B[0].height); else {
        var D = new Image;
        D.src = B[0].src, B.width
          (D.width), B.height(D.height)
      }
    ...
    var M = d.boundary, N = z().width(F + M * 2).height(G + M * 2).css({position:"absolute", top:h(-M), left:h(-M), zIndex:290}).mousedown(v), O = d.bgColor, P = d.bgOpacity, Q, R, S, T, U, V, W = !0,
      X, Y, Z;
    e = k(E);
    var _ = function () {
      function a() {
      ...
      function k(d) {
        var f = d[0], g = d[1];
        0 > a + f && (f -= f + a), 0 > b + g && (g -= g + b), G < e + g && (
          g += G - (e + g)), F < c + f && (f += F - (c + f)), a += f, c += f, b += g, e += g
      }
      ...
      function o(a, b, c, d) {
        var e = a, f = c, g = b, h = d;
        return c < a && (e = c, f = a), d < b && (g = d, h = b), [Math.round(e),
          Math.round(g), Math.round(f), Math.round(h)]
      }
      ...
      function j() {
        return a("<div />").css({position:"absolute", backgroundColor:d.shadeColor || d.bgColor
        }).appendTo(c)
      }
      ...
      function l(b, c) {
        var d = a("<div />").mousedown(r(b)).css({cursor:b + "-resize", position:"absolute", zIndex:c}).addClass("ord-" +
          b);
      ...
      function y(a, c, e) {
        if (!b && !c)return;
        d.bgFade && !e ? E.animate({opacity:a}, {queue:!1, duration:d.fadeTime
        }) : E.css("opacity", a)
      }
