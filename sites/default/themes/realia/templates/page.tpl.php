    ...
    <div id="wrapper-inner">
      ...
      <div id="map">
        ...
        if (empty($arg[0]) || (isset($arg[0]) && in_array($arg[0], array('communities', 'apartments'))) || (!empty($comm) && $comm->vocabulary_machine_name == 'communities')):
          ?>
          <div id="MyGmaps" style="width: 100%; height: 640px; border: 1px 0px 1px 0px solid rgb(206, 206, 206); position: relative; background-color: rgb(229, 227, 223);  overflow: hidden;">&nbsp;</div>
        <?php endif; ?>
      </div>
